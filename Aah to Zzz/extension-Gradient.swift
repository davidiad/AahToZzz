...
//    }
//    
//    func updateGradient(hue1: CGFloat, hue2: CGFloat, hue3: CGFloat, hue4: CGFloat) -> CAGradientLayer {
//        
//        let colorOne = UIColor(hue: hue1, saturation: 0.70, brightness: 0.75, alpha: 1).CGColor as CGColorRef
//        let colorTwo = UIColor(hue: hue2, saturation: 0.75, brightness: 1.00, alpha: 1).CGColor as CGColorRef
//        let colorThree = UIColor(hue: hue3, saturation: 0.70, brightness: 0.75, alpha: 1).CGColor as CGColorRef
//        let colorFour = UIColor(hue: hue4, saturation: 1.0, brightness: 1.0, alpha: 1).CGColor as CGColorRef
//        
//        let gradientColors: Array <AnyObject> = [colorOne, colorTwo, colorThree, colorFour]
//        
//        
